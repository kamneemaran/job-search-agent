        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "status": {
                        "type": "string",
                        "description": "New status: 'applied', 'rejected', 'offer', 'interview', 'expired', 'na'",
                        "enum": ["applied", "rejected", "offer", "interview", "expired", "na"],
                    },
...
def _tracker_status(status: str = "", limit: int = 20) -> str:
    ...
    for j in filtered:
        status_icon = {"new": "🆕", "applied": "✅", "rejected": "❌", "offer": "🎉", "interview": "🎙️", "expired": "⏳", "na": "🚫"}
